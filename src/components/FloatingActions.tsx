  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      <a
        ...
        rel="noreferrer"
        aria-label="WhatsApp"
        className="group inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-deep hover:scale-110 transition-transform"
      >
      ...
      <a
        ...
        aria-label="Call"
        className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-ember shadow-ember hover:scale-110 transition-transform"
      >
